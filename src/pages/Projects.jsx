...
const Projects = () => {
  return (
    ...
    <div className='bg-[#3189ac] py-40'>
      ...
      <p className='text-center'> <span className='font-semibold text-6xl'>My Recent Works</span> <br /> <br /> <span className='text-3xl'>Here are a few projects I've worked on recently</span></p>
